...
# Generated on: Wed May 14 14:25:35 -03 2025 (Wed May 14 17:25:35 UTC 2025)
...
set logfile fv/hdec/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/hdec -revised fv_map
...
add_search_path /home/ci_inovador/Documentos/rom/frontend/source -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /home/ci_inovador/Documentos/rom/frontend/source/hdec.sv
elaborate_design -golden -root {hdec} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/hdec/fv_map.v.gz
elaborate_design -revised -root {hdec}
...
#add_name_alias fv/hdec/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.hdec.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.hdec.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.hdec.rtl.fv_map.rpt
