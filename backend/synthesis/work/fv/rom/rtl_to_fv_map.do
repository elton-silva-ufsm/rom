...
# Generated on: Thu May 22 14:01:38 -03 2025 (Thu May 22 17:01:38 UTC 2025)
...
set logfile fv/rom/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/rom -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /home/ci_inovador/Documentos/rom/frontend/source/rom.sv /home/ci_inovador/Documentos/rom/frontend/source/hdec.sv
elaborate_design -golden -root {rom} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/rom/fv_map.v.gz
elaborate_design -revised -root {rom}
...
set_system_mode lec
write_compared_points noneq.compared_points.rom.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.rom.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.rom.rtl.fv_map.rpt
