...
set period_clk $CLK_PERIOD  ;# (100 ns = 10 MHz) (10 ns = 100 MHz) (2 ns = 500 MHz) (1 ns = 1 GHz)
...
# io
# read_netlist "../../synthesis/deliverables/${DESIGNS}.v ../../synthesis/deliverables/${DESIGNS}_chip.v ../../synthesis/deliverables/${DESIGNS}_io.v"
# read_io_file ../scripts/design_chip.io
...
create_floorplan -core_margins_by die -site CoreSite -core_density_size 0.2 0.8 2.5 2.5 2.5 2.5
